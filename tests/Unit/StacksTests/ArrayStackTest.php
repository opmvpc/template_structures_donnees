...
describe('ArrayStack', function () {
    it('should be instance of StackInterface', function () {
        $stack = new \Opmvpc\StructuresDonnees\Stacks\ArrayStack();
        expect($stack)->toBeInstanceOf(\Opmvpc\StructuresDonnees\Stacks\StackInterface::class);
        expect($stack)->toBeInstanceOf(\Opmvpc\StructuresDonnees\Stacks\ArrayStack::class);
    });
    ...
    // a lot of push and top
    it('should push and top a lot of elements', function () {
        $stack = new \Opmvpc\StructuresDonnees\Stacks\ArrayStack();
        for ($i = 0; $i < 100; $i++) {
            $stack->push($i);
